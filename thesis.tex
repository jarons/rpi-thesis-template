...
\usepackage[letterpaper,footskip=0.25in,margin=1in]{geometry}
\geometry{headsep=0.1455in,headheight=0.167in,top=1in}
  % Put header page number 3/4" from top edge.
